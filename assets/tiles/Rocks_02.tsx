...
<tileset version="1.10" tiledversion="1.11.0" name="Rocks_02" tilewidth="16" tileheight="16" tilecount="512" columns="64">
 <image source="../images/Terrain/Water/Rocks/Rocks_02.png" width="1024" height="128"/>
 <tile id="194">
  <animation>
 ...
 <tile id="196">
  <animation>
   <frame tileid="196" duration="200"/>
   <frame tileid="204" duration="200"/>
   <frame tileid="212" duration="200"/>
 ...
 <tile id="259">
  <animation>
   ...
   <frame tileid="307" duration="200"/>
   <frame tileid="315" duration="200"/>
  </animation>
 </tile>
 <tile id="260">
  <animation>
