...
class TowerComponent extends SpriteComponent
  ...
  TowerComponent({required Vector2 position})
      : super(
          position: position,
        );
  ...
  FutureOr<void> onLoad() async {
    ...
    sprite =
        await Sprite.load('Factions/Knights/Buildings/Tower/Tower_Blue.png');
...
// Add this private method to award gold to the player
  ...
  void _awardGoldToPlayer() {
    try {
      ...
      int goldAmount = 100; // Base gold amount
